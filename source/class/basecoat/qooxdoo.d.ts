...
declare module qx.registry {
  function registerMainMethod(
    fn: (app: qx.application.Standalone) => void,
  ): void;
}
...
declare module qx.ui.decoration {
  class Decorator
    ...
    implements qx.ui.decoration.IDecorator
  {
    getStyles(): IMap;
    getPadding(): IMap;
    getInsets(): IMap;
    ...
    protected _getExtendedPropertyValueArrays(
      propertyNames: qx.data.Array,
    ): qx.data.Array;
  }
}
declare module qx.ui.decoration {
...
declare module qx.ui.tree.core {
  class AbstractTreeItem extends qx.ui.tree.core.AbstractItem {
    ...
    addBefore(
      treeItem: qx.ui.tree.core.AbstractTreeItem,
      before: qx.ui.tree.core.AbstractTreeItem,
    ): void;
    addAfter(
      treeItem: qx.ui.tree.core.AbstractTreeItem,
      after: qx.ui.tree.core.AbstractTreeItem,
    ): void;
...
declare module qx.ui.tree.core {
  class MWidgetController {
    ...
    bindProperty(
      ...
      options: IMap | null,
      targetWidget: qx.ui.core.Widget,
      index: number,
    ): void;
    bindPropertyReverse(
      ...
      options: IMap | null,
      sourceWidget: qx.ui.core.Widget,
      index: number,
    ): void;
    removeBindings(): void;
...
declare module qx.ui.tree.core {
  interface IVirtualTreeDelegate {
    ...
    bindItem(
      controller: qx.ui.list.core.MWidgetController,
      item: qx.ui.core.Widget,
      id: number,
    ): void;
...
declare module qx.ui.tree {
  class VirtualTree
    ...
    implements qx.ui.tree.core.IVirtualTree, qx.data.controller.ISelection
  {
    isShowTopLevelOpenCloseIcons(): boolean;
    getLookupTable(): qx.data.Array;
    isNode(item: qx.core.Object): boolean;
...
declare module qx.ui.tree {
      ...
      qx.ui.form.IForm
  {
    ...
    getNextNodeOf(
      treeItem: qx.ui.tree.core.AbstractTreeItem,
      invisible?: boolean,
    ): qx.ui.tree.core.AbstractTreeItem | null;
    getPreviousNodeOf(
      treeItem: qx.ui.tree.core.AbstractTreeItem,
      invisible?: boolean,
    ): qx.ui.tree.core.AbstractTreeItem | null;
...
declare module qx.ui.treevirtual {
  class MNode {
    ...
    nodeOpenAll(): void;
    nodeCloseAll(): void;
    protected _nodeSetOpenedInternal(
...
declare module qx.ui.treevirtual {
  class MTreePrimitive {
    static Type: any;
    protected static _addNode(
      nodeArr: qx.data.Array | IMap,
      parentNodeId: number,
      label: string,
      bOpened: boolean,
      bHideOpenCloseButton: boolean,
      type: number,
      icon: string,
      iconSelected: string,
      nodeId?: number,
...
declare module qx.ui.treevirtual {
  class SimpleTreeDataModel extends qx.ui.table.model.Abstract {
    ...
    move(
      moveNodeReference: {} | number,
      parentNodeReference: {} | number,
    ): void;
...
declare module qx.ui.treevirtual {
  class SelectionManager extends qx.ui.table.selection.Manager {
    ...
    protected _handleExtendedClick(
...
declare module qx.ui.treevirtual {
  class SimpleTreeDataCellRenderer extends qx.ui.table.cellrenderer.Abstract {
    ...
    protected _addExtraContentBeforeIndentation(
      cellInfo: IMap,
      pos: number,
    ): IMap;
    ...
    protected _getIndentSymbol(
      column: number,
      node: Node,
      bUseTreeLines: boolean,
      bAlwaysShowOpenCloseSymbol: boolean,
      bExcludeFirstLevelTreeLines: boolean,
    ): IMap;
...
declare module qx.ui.form {
  class AbstractSelectBox
    extends qx.ui.core.Widget
    implements qx.ui.form.IForm
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
    ...
    addBefore(
      child: qx.ui.core.LayoutItem,
      before: qx.ui.core.LayoutItem,
      options?: IMap,
    ): void;
    addAfter(
      child: qx.ui.core.LayoutItem,
      after: qx.ui.core.LayoutItem,
      options?: IMap,
    ): void;
...
declare module qx.ui.form {
  class CheckedSelectBox
    extends qx.ui.form.AbstractSelectBox
    implements
      qx.ui.core.IMultiSelection,
      qx.ui.form.IModelSelection,
      qx.ui.form.IField
...
declare module qx.ui.form.renderer {
  class AbstractRenderer
    extends qx.ui.core.Widget
    implements qx.ui.form.renderer.IFormRenderer
  {
    addItems(
      items: qx.ui.core.Widget[],
      names: string[],
      title?: string,
      itemsOptions?: qx.data.Array,
      headerOptions?: IMap,
    ): void;
...
declare module qx.ui.form.core {
    ...
    implements qx.ui.form.IForm
  {
    ...
    protected _handleKeyboard(event: qx.event.type.KeySequence): void;
    protected _handlePointer(
      event: qx.event.type.Pointer | qx.event.type.Roll,
    ): void;
...
declare module qx.ui.form {
  class Spinner
    extends qx.ui.core.Widget
    implements qx.ui.form.INumberForm, qx.ui.form.IRange, qx.ui.form.IForm
  {
    setMinimum(min: number): void;
    getMinimum(): number;
    setMaximum(max: number): void;
...
declare module qx.ui.form {
  class Slider
    extends qx.ui.core.Widget
    implements qx.ui.form.IForm, qx.ui.form.INumberForm, qx.ui.form.IRange
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
...
declare module qx.ui.form {
  class CheckBox
    extends qx.ui.form.ToggleButton
    implements qx.ui.form.IForm, qx.ui.form.IModel, qx.ui.form.IListItem
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
...
declare module qx.ui.form {
  class VirtualSelectBox
    extends qx.ui.form.core.AbstractVirtualBox
    implements qx.data.controller.ISelection, qx.ui.form.IField
  {
    setSelection(value: qx.data.IListData): void;
...
declare module qx.ui.form {
  class SplitButton
    extends qx.ui.core.Widget
    implements qx.ui.form.IExecutable
  {
    setCommand(command: qx.ui.command.Command): void;
    getCommand(): qx.ui.command.Command;
    execute(): void;
    ...
    constructor(
      label?: string,
      icon?: string,
      menu?: qx.ui.menu.Menu,
      command?: qx.ui.command.Command,
    );
    protected _applyLabel(): void;
    protected _applyIcon(): void;
    protected _applyMenu(): void;
...
declare module qx.ui.form {
  class DateField
    extends qx.ui.core.Widget
    implements qx.ui.form.IForm, qx.ui.form.IDateForm
  {
    setValue(value: any);
    resetValue(): void;
    getValue();
...
declare module qx.ui.form {
  class VirtualComboBox
    extends qx.ui.form.core.AbstractVirtualBox
    implements qx.ui.form.IStringForm
  {
...
declare module qx.ui.form {
  class ListItem
    extends qx.ui.basic.Atom
    implements qx.ui.form.IModel, qx.ui.form.IListItem
  {
    setModel(value: any): void;
    getModel(): any;
    resetModel(): void;
...
declare module qx.ui.form {
  class AbstractField
    extends qx.ui.core.Widget
    implements qx.ui.form.IStringForm, qx.ui.form.IForm
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
    ...
    protected _renderContentElement(
      innerHeight: number,
      element: HTMLElement,
    ): void;
...
declare module qx.ui.form {
  class Form extends qx.core.Object {
    add(
      item: qx.ui.form.IForm,
      label: string,
      validator?: Function | qx.ui.form.validation.AsyncValidator,
      name?: string,
...
declare module qx.ui.form.validation {
  class AsyncValidator extends qx.core.Object {
    ...
    validate(
      item: qx.ui.core.Widget,
      value: any,
      manager: qx.ui.form.validation.Manager,
      context?: any,
    ): void;
    validateForm(
      items: qx.ui.core.Widget[],
...
declare module qx.ui.core {
  class Widget extends qx.ui.core.LayoutItem implements qx.core.IDisposable {
    ...
    trn(
      singularMessageId: string,
      pluralMessageId: string,
      count: number,
      ...varargs: {}[]
    ): any;
    ...
    static getWidgetByElement(
      element: HTMLElement,
      considerAnonymousState?: boolean,
    ): qx.ui.core.Widget;
    static contains(
      parent: qx.ui.core.Widget,
      child: qx.ui.core.Widget,
    ): boolean;
    ...
    protected _createChildControlImpl(
      id: string,
      hash?: string,
    ): qx.ui.core.Widget;
...
declare module qx.ui.core.scroll {
  class ScrollBar
    extends qx.ui.core.Widget
    implements qx.ui.core.scroll.IScrollBar
  {
...
declare module qx.ui.core.scroll {
  class AbstractScrollArea extends qx.ui.core.Widget {
    ...
    protected _isScrollbarVisible(
      scrollable: qx.ui.core.Widget,
      axis: string,
    ): boolean;
    protected _isScrollbarExceedingMaxPos(
      scrollbar: qx.ui.core.scroll.IScrollBar,
      axis: string,
      amount: number,
    ): boolean;
    protected _calculateThresholdExceedance(
      diff: number,
      threshold: number,
    ): number;
    protected _calculateScrollAmount(
...
declare module qx.ui.core.selection {
  class Abstract extends qx.core.Object {
    ...
    protected _getSelectableFromPointerEvent(
      event: qx.event.type.Pointer,
    ): {} | null;
...
declare module qx.ui.core {
  class LayoutItem extends qx.core.Object {
    ...
    renderSeparator(
      separator: string | qx.ui.decoration.IDecorator,
      bounds: IMap,
    ): void;
    renderLayout(
      left: number,
...
declare module qx.ui.layout {
  class Dock extends qx.ui.layout.Abstract {
    constructor(
      spacingX?: number,
      spacingY?: number,
      separatorX?: string | qx.ui.decoration.IDecorator,
      separatorY?: string | qx.ui.decoration.IDecorator,
    );
...
declare module qx.ui.layout {
  class Util {
    ...
    static computeFlexOffsets(
      flexibles: IMap,
      avail: number,
      used: number,
    ): IMap;
    static computeHorizontalAlignOffset(
      align: string,
      width: number,
      availWidth: number,
      marginLeft?: number,
    ...
    static computeVerticalAlignOffset(
      align: string,
      height: number,
      availHeight: number,
      marginTop?: number,
    ...
    static computeHorizontalGaps(
      children: qx.data.Array,
      spacing?: number,
      collapse?: boolean,
    ): number;
    static computeVerticalGaps(
      children: qx.data.Array,
      spacing?: number,
      collapse?: boolean,
    ): number;
    static computeHorizontalSeparatorGaps(
      children: qx.ui.core.LayoutItem[],
      spacing: number,
      separator: string | qx.ui.decoration.IDecorator,
    ): number;
    static computeVerticalSeparatorGaps(
      children: qx.ui.core.LayoutItem[],
      spacing: number,
      separator: string | qx.ui.decoration.IDecorator,
    ): number;
    static arrangeIdeals(
      beginMin: number,
      beginIdeal: number,
      beginMax: number,
      endMin: number,
...
declare module qx.ui.toolbar {
  class RadioButton
    extends qx.ui.toolbar.CheckBox
    implements qx.ui.form.IModel, qx.ui.form.IRadioItem
  {
    setModel(value: any): void;
    getModel(): any;
    resetModel(): void;
...
declare module qx.ui.toolbar {
  class ToolBar extends qx.ui.core.Widget {
    ...
    constructor(layout?: qx.ui.layout.Abstract);
    protected _onResize(e: qx.event.type.Data): void;
    protected _recalculateOverflow(
      width?: number,
...
declare module qx.ui.tabview {
  class TabView
    extends qx.ui.core.Widget
    implements qx.ui.core.ISingleSelection
  {
    getSelection(): qx.ui.core.Widget[];
    setSelection(items: qx.ui.core.Widget[]): void;
    resetSelection(): void;
...
declare module qx.ui.tabview {
  class TabButton
    extends qx.ui.form.RadioButton
    implements qx.ui.form.IRadioItem
  {
    setValue(value: boolean): void;
    getValue(): boolean;
    setGroup(value: qx.ui.form.RadioGroup): void;
...
declare module qx.ui.container {
  class Stack
    extends qx.ui.core.Widget
    implements qx.ui.form.IField, qx.ui.core.ISingleSelection
  {
    setValue(value: any | null): any;
    resetValue(): void;
    getValue(): any | null;
...
declare module qx.ui.progressive.renderer.table.cell {
  class Conditional extends qx.ui.progressive.renderer.table.cell.Abstract {
    constructor(
      align?: qx.ui.progressive.renderer.table.cell.String,
      color?: qx.ui.progressive.renderer.table.cell.String,
      style?: qx.ui.progressive.renderer.table.cell.String,
      weight?: qx.ui.progressive.renderer.table.cell.String,
    );
    addNumericCondition(
      condition: qx.ui.progressive.renderer.table.cell.String,
      value1: number,
      align: qx.ui.progressive.renderer.table.cell.String,
      color: qx.ui.progressive.renderer.table.cell.String,
      style: qx.ui.progressive.renderer.table.cell.String,
      weight: qx.ui.progressive.renderer.table.cell.String,
      target: qx.ui.progressive.renderer.table.cell.String,
    ): void;
    addBetweenCondition(
      condition: qx.ui.progressive.renderer.table.cell.String,
      value1: number,
    ...
    addRegex(
      regex: qx.ui.progressive.renderer.table.cell.String,
      align: qx.ui.progressive.renderer.table.cell.String,
      color: qx.ui.progressive.renderer.table.cell.String,
      style: qx.ui.progressive.renderer.table.cell.String,
      weight: qx.ui.progressive.renderer.table.cell.String,
...
declare module qx.ui.progressive.renderer.table {
  class Row extends qx.ui.progressive.renderer.Abstract {
    ...
    addRenderer(
      column: number,
      renderer: qx.ui.progressive.renderer.table.cell.Abstract,
    ): void;
...
declare module qx.ui.progressive.headfoot {
  class TableHeading extends qx.ui.progressive.headfoot.Abstract {
    constructor(
      columnWidths?: qx.ui.progressive.renderer.table.Widths,
      labelArr?: qx.data.Array,
    );
    protected _resizeColumns(e: qx.event.type.Event): void;
    destruct(): void;
  }
...
declare module qx.ui.progressive.structure {
  class Default extends qx.ui.progressive.structure.Abstract {
    constructor(
      header?: qx.ui.progressive.headfoot.Abstract | null,
      footer?: qx.ui.progressive.headfoot.Abstract | null,
      pane?: qx.ui.core.Widget | null,
    );
...
declare module qx.ui.progressive {
  class Progressive extends qx.ui.container.Composite {
    ...
    addRenderer(
      name: string,
      renderer: qx.ui.progressive.renderer.Abstract,
    ): void;
    removeRenderer(name: string): void;
    render(): void;
    protected _applyDataModel(
      value: qx.ui.progressive.model.Abstract,
      old: qx.ui.progressive.model.Abstract,
    ): void;
...
declare module qx.ui.table.pane {
  class Pane extends qx.ui.core.Widget {
    ...
    updateContent(
      ...
      scrollOffset?: number,
      onlyRow?: number,
      onlySelectionOrFocusChanged?: boolean,
    ): void;
...
declare module qx.ui.table.columnmenu {
  class MenuItem
    ...
    implements qx.ui.table.IColumnMenuItem
  {
...
declare module qx.ui.table.columnmenu {
  class Button
    ...
    implements qx.ui.table.IColumnMenuButton
  {
    factory(item: string, options: IMap): qx.ui.core.Widget;
    empty(): void;
    getMenu(): any;
...
declare module qx.ui.table.celleditor {
  class Dynamic
    extends qx.core.Object
    implements qx.ui.table.ICellEditorFactory
  {
    createCellEditor(cellInfo: IMap): qx.ui.core.Widget;
    getCellEditorValue(cellEditor: qx.ui.core.Widget): any;
...
declare module qx.ui.table.cellrenderer {
  class Conditional extends qx.ui.table.cellrenderer.Default {
    ...
    addNumericCondition(
      condition: qx.ui.table.cellrenderer.String,
      value1: number,
      align: string | null,
      color: string | null,
      style: string | null,
    ...
    addRegex(
      regex: qx.ui.table.cellrenderer.String,
      align: string | null,
      color: string | null,
      style: string | null,
      weight: string | null,
...
declare module qx.ui.table.model {
  class Simple extends qx.ui.table.model.Abstract {
    protected static _defaultSortComparatorAscending(
      row1: any,
      row2: any,
      columnIndex: number,
    ): number;
    protected static _defaultSortComparatorInsensitiveAscending(
      row1: any,
      row2: any,
      columnIndex: number,
    ): number;
    protected static _defaultSortComparatorDescending(
      row1: any,
      row2: any,
      columnIndex: number,
    ): number;
    protected static _defaultSortComparatorInsensitiveDescending(
      row1: any,
      row2: any,
      columnIndex: number,
    ): number;
...
declare module qx.ui.table.model {
  class Filtered extends qx.ui.table.model.Simple {
    ...
    protected _js_in_array(
      the_needle: string,
      the_haystack: qx.data.Array,
    ): boolean;
    addBetweenFilter(
      filter: string,
      value1: number,
...
declare module qx.ui.mobile.page {
  class NavigationPage
    extends qx.ui.mobile.page.Page
    implements qx.ui.mobile.container.INavigation
  {
    ...
    constructor(
      wrapContentByGroup?: boolean,
      layout?: qx.ui.mobile.layout.Abstract,
    );
  ...
  class Manager extends qx.core.Object {
    ...
    protected _add(
      pages:
        | qx.ui.mobile.page.NavigationPage
        | qx.ui.mobile.page.NavigationPage,
      target: qx.ui.mobile.container.Navigation,
    ): void;
...
declare module qx.ui.mobile.form.renderer {
  class Single extends qx.ui.mobile.form.renderer.AbstractRenderer {
    ...
    protected _addToScrollContainer(
      item: qx.ui.mobile.core.Widget,
      name: string,
    ): void;
    protected _addRow(
      item: qx.ui.mobile.core.Widget,
...
declare module qx.ui.mobile.form {
  class RadioButton
    extends qx.ui.mobile.form.Input
    implements qx.ui.form.IField
  {
    setValue(value: any | null): any;
    resetValue(): void;
    getValue(): any | null;
    ...
    protected _applyGroup(
      value: qx.ui.form.RadioGroup,
      old: qx.ui.form.RadioGroup,
    ): void;
...
declare module qx.ui.mobile.form {
  class Input
    extends qx.ui.mobile.core.Widget
    implements qx.ui.form.IForm, qx.ui.form.IModel
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
...
declare module qx.ui.mobile.form {
  class Slider
    extends qx.ui.mobile.core.Widget
    implements qx.ui.form.IForm, qx.ui.form.IModel, qx.ui.form.INumberForm
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
...
declare module qx.ui.mobile.form {
  class SelectBox
    extends qx.ui.mobile.core.Widget
    implements qx.ui.form.IForm, qx.ui.form.IField, qx.ui.form.IModel
  {
    setEnabled(enabled: boolean): void;
    getEnabled(): boolean;
    setRequired(required: boolean): void;
...
declare module qx.ui.mobile.form {
  class ToggleButton
    extends qx.ui.mobile.core.Widget
    implements qx.ui.form.IField, qx.ui.form.IForm, qx.ui.form.IModel
  {
    setValue(value: any | null): any;
    resetValue(): void;
    getValue(): any | null;
...
declare module qx.ui.mobile.core {
  class Widget extends qx.core.Object {
    ...
    protected _addBefore(
      child: qx.ui.core.Widget,
      beforeWidget: qx.ui.core.Widget,
      layoutProperties?: IMap,
    ): void;
    protected _addAfter(
      child: qx.ui.core.Widget,
      afterWidget: qx.ui.core.Widget,
      layoutProperties?: IMap,
    ): void;
    ...
    protected _initializeChildLayout(
      child: qx.ui.core.Widget,
      layoutProperties?: IMap,
    ): void;
    ...
    updateLayoutProperties(
      widget: qx.ui.mobile.core.Widget,
      properties: IMap,
    ): void;
    updateLayout(
      widget: qx.ui.mobile.core.Widget,
...
declare module qx.ui.mobile.core {
  class MChildrenHandling {
    ...
    addBefore(
      child: qx.ui.core.Widget,
      before: qx.ui.core.Widget,
      layoutProperties?: IMap,
    ): void;
    addAfter(
      child: qx.ui.core.Widget,
      after: qx.ui.core.Widget,
      layoutProperties?: IMap,
    ): void;
...
declare module qx.ui.mobile.core {
  class DomUpdatedHandler
    extends qx.core.Object
    implements qx.event.IEventHandler
  {
    canHandleEvent(target: any, type: string): boolean;
    registerEvent(target: any, type: string, capture: boolean): void;
    unregisterEvent(target: any, type: string, capture: boolean): void;
...
declare module qx.ui.mobile.layout {
  class Abstract extends qx.core.Object {
    ...
    protected _getChildLayoutPropertyValue(
      widget: qx.ui.mobile.core.Widget,
      property: string,
    ): any;
    protected _addPropertyToChildLayoutCache(
      widget: qx.ui.mobile.core.Widget,
      property: string,
      value: any,
    ): void;
...
declare module qx.ui.mobile.basic {
  class Image extends qx.ui.mobile.core.Widget {
    ...
    protected _createHighResolutionOverlay(
...
declare module qx.ui.mobile.dialog {
  class Menu extends qx.ui.mobile.dialog.Popup {
    ...
    protected _createListScroller(
      selectionList: qx.ui.mobile.list.List,
...
declare module qx.ui.mobile.dialog {
  class Popup extends qx.ui.mobile.core.Widget {
    constructor(
      widget?: qx.ui.mobile.core.Widget,
      anchor?: qx.ui.mobile.core.Widget,
    );
    static ROOT: any;
...
declare module qx.ui.mobile.container {
  class Drawer extends qx.ui.mobile.container.Composite {
    constructor(
      parent?: qx.ui.mobile.container.Composite,
      layout?: qx.ui.mobile.layout.Abstract,
    );
    protected _applyOrientation(): void;
...
declare module qx.ui.mobile.container {
  class Scroll extends qx.ui.mobile.container.Composite {
    ...
    protected _calcWaypoints(
      waypoints: qx.data.Array,
      results: qx.data.Array,
      scrollSize: number,
      axis?: string,
    ): void;
...
declare module qx.ui.mobile.container {
  class Carousel extends qx.ui.mobile.container.Composite {
    ...
    protected _onSwipe(evt: qx.event.type.Swipe): void;
    protected _calculateTransitionDuration(
      deltaX: number,
      duration: number,
    ): number;
...
declare module qx.ui.mobile.list.provider {
  class Provider extends qx.core.Object {
    protected _setItemRenderer(
      renderer: qx.ui.mobile.list.renderer.Abstract,
    ): void;
    protected _getItemRenderer(): qx.ui.mobile.list.renderer.Abstract;
    protected _setGroupRenderer(
      renderer: qx.ui.mobile.list.renderer.group.Abstract,
    ): void;
...
declare module qx.ui.mobile.list {
  interface IListDelegate {
    configureItem(
      item: qx.ui.mobile.list.renderer.Abstract,
      data: any,
      row: number,
    ): void;
...
declare module qx.ui.mobile.control {
  class Picker extends qx.ui.mobile.container.Composite {
    ...
    getModel(): qx.data.Array;
    protected _createPickerSlot(
      slotModel: qx.data.Array,
      slotIndex: number,
      delegate?: qx.ui.mobile.list.IListDelegate,
    ): qx.ui.mobile.container.Scroll;
...
declare module qx.ui.window {
  interface IWindowManager {
    ...
    changeActiveWindow(
      active: qx.ui.window.Window,
      oldActive: qx.ui.window.Window,
    ): void;
    updateStack(): void;
...
declare module qx.ui.list {
  class List
    extends qx.ui.virtual.core.Scroller
    implements qx.data.controller.ISelection
  {
    setSelection(value: qx.data.IListData): void;
    getSelection(): qx.data.IListData;
    resetSelection(): void;
...
declare module qx.ui.virtual.core {
  class Pane extends qx.ui.core.Widget {
    ...
    protected _setLayerWindow(
      layers: qx.ui.virtual.core.ILayer[],
      left: number,
      top: number,
      minWidth: number,
      minHeight: number,
...
declare module qx.ui.virtual.cell {
  class Cell extends qx.ui.virtual.cell.Abstract {
    ...
    protected _storeStyle(
      propertyName: qx.ui.virtual.cell.String,
      styles: qx.ui.virtual.cell.String,
    ): void;
    protected _applyBackgroundColor(): void;
    protected _applyTextColor(): void;
    protected _applyTextAlign(): void;
...
declare module qx.ui.virtual.cell {
  class AbstractWidget
    extends qx.core.Object
    implements qx.ui.virtual.cell.IWidgetCell
  {
...
declare module qx.ui.virtual.cell {
  class CellStylesheet extends qx.core.Object {
    ...
    computeClassForStyles(
      key: qx.ui.virtual.cell.String,
      styleString: qx.ui.virtual.cell.String,
...
declare module qx.ui.virtual.layer {
  class CellSpanManager extends qx.core.Object {
    constructor(
      rowConfig?: qx.ui.virtual.core.Axis,
      columnConfig?: qx.ui.virtual.core.Axis,
    );
    addCell(
      id: string,
      row: number,
    ...
    protected _getSingleCellBounds(
      cell: IMap,
      firstVisibleRow: IMap,
      firstVisibleColumn: IMap,
    ): IMap;
    getCellBounds(
      cells: IMap[],
      firstVisibleRow: IMap,
...
declare module qx.ui.virtual.layer {
  class WidgetCellSpan extends qx.ui.virtual.layer.Abstract {
    ...
    removeAll(): qx.data.Array;
    constructor(
      widgetCellProvider?: qx.ui.virtual.core.IWidgetCellProvider,
      rowConfig?: qx.ui.virtual.core.Axis,
      columnConfig?: qx.ui.virtual.core.Axis,
    );
    getRenderedCellWidget(
...
declare module qx.ui.virtual.layer {
  class AbstractBackground extends qx.ui.virtual.layer.Abstract {
    ...
    setBackground(
      index: number,
      decorator: qx.ui.decoration.IDecorator | null,
    ): void;
...
declare module qx.ui.virtual.layer {
  class HtmlCellSpan extends qx.ui.virtual.layer.HtmlCell {
    constructor(
      htmlCellProvider?: qx.ui.virtual.core.IHtmlCellProvider,
      rowConfig?: qx.ui.virtual.core.Axis,
      columnConfig?: qx.ui.virtual.core.Axis,
    );
    setCellSpan(
...
declare module qx.ui.virtual.layer {
  class Abstract
    extends qx.ui.core.Widget
    implements qx.ui.virtual.core.ILayer
  {
    fullUpdate(
      firstRow: number,
      firstColumn: number,
    ...
    protected _fullUpdate(
      firstRow: number,
      firstColumn: number,
      rowSizes: number[],
      columnSizes: number[],
    ): void;
    protected _updateLayerWindow(
      firstRow: number,
      firstColumn: number,
      rowSizes: number[],
      columnSizes: number[],
...
declare module qx.ui.virtual.selection {
  class Abstract extends qx.ui.core.selection.Abstract {
    constructor(
      ...
      selectionDelegate?: qx.ui.virtual.selection.ISelectionDelegate,
    );
...
declare module qx.ui.menu {
  class RadioButton
    ...
    implements qx.ui.form.IRadioItem, qx.ui.form.IBooleanForm, qx.ui.form.IModel
  {
    setValue(value: boolean): void;
    getValue(): boolean;
    setGroup(value: qx.ui.form.RadioGroup): void;
...
declare module qx.ui.menu {
  class CheckBox
    extends qx.ui.menu.AbstractButton
    implements qx.ui.form.IBooleanForm
  {
    constructor(label?: string, menu?: qx.ui.menu.Menu);
    protected _applyValue(): void;
    protected _onExecute(e: qx.event.type.Event): void;
...
declare module qx.ui.menu {
  class Manager extends qx.core.Object {
    ...
    protected _onKeyPressEnter(
      menu: qx.ui.menu.Menu,
      button: qx.ui.menu.AbstractButton,
      e: qx.event.type.KeySequence,
    ): void;
    protected _onKeyPressSpace(
      menu: qx.ui.menu.Menu,
      button: qx.ui.menu.AbstractButton,
      e: qx.event.type.KeySequence,
    ): void;
...
declare module qx.ui.control {
  class DateChooser
    extends qx.ui.core.Widget
    implements qx.ui.form.IExecutable, qx.ui.form.IForm, qx.ui.form.IDateForm
  {
    setCommand(command: qx.ui.command.Command): void;
    getCommand(): qx.ui.command.Command;
    execute(): void;
...
declare module qx.ui.control {
  class ColorSelector
    extends qx.ui.core.Widget
    implements qx.ui.form.IColorForm
  {
    setValue(value: any);
    resetValue(): void;
    getValue();
...
declare module qx.ui.groupbox {
  class RadioGroupBox
    extends qx.ui.groupbox.GroupBox
    implements
      qx.ui.form.IRadioItem,
      qx.ui.form.IExecutable,
      qx.ui.form.IBooleanForm,
...
declare module qx.locale {
  class String {
    ...
    static getAlternateQuotationStart(
      locale: qx.locale.String,
    ): qx.locale.String;
...
declare module qx.bom {
  class Vml {
    ...
    static updateImage(
      image: qx.bom.Element,
      source: qx.bom.String,
      width: number,
      height: number,
      xOffset?: number,
      yOffset?: number,
...
declare module qx.bom {
  class Template {
    ...
    static render: any;
    static renderToNode(
      template: qx.bom.String,
      view: {},
      partials: {},
    ): HTMLElement;
    static get(id: qx.bom.String, view: {}, partials: {}): HTMLElement;
    protected static _createNodeFromTemplate(
      template: qx.bom.String,
    ): HTMLElement;
  }
}
...
declare module qx.bom {
  class Input {
    ...
    static setValue(
      element: HTMLElement,
      value: string | number | qx.data.Array,
    ): void;
...
declare module qx.bom.element {
  class AnimationJs {
    ...
    static play(
      handle: qx.bom.element.AnimationHandle,
    ): qx.bom.element.AnimationHandle;
    static pause(
      handle: qx.bom.element.AnimationHandle,
    ): qx.bom.element.AnimationHandle;
...
declare module qx.bom.element {
  class Transform {
    ...
    protected static _compute3dProperty(
      property: string,
      params: qx.data.Array,
    ): string;
    protected static _computeAxisProperties(
      property: string,
      params: qx.data.Array,
    ): string;
  }
...
declare module qx.bom {
  class Style {
    ...
    static getAppliedStyle(
      element: HTMLElement,
      propertyName: qx.bom.String,
      value: qx.bom.String,
      prefixed?: boolean,
    ): string | null;
  }
...
declare module qx.bom.request {
  class SimpleXhr extends qx.event.Emitter implements qx.core.IDisposable {
    ...
    protected _registerTransportListener(
      transport: qx.bom.request.IRequest,
...
declare module qx.bom {
  class Html {
    ...
    static clean(
      objs: HTMLElement | string,
      context?: Document,
      fragment?: HTMLElement,
    ): HTMLElement[];
    static extractScripts(
...
declare module qx.core {
  class Object {
    bind(
      sourcePropertyChain: string,
      targetObject: qx.core.Object,
      targetProperty?: string,
      options?: IMap,
    ): any;
...
declare module qx.core {
  class Assert {
    ...
    static assertEqualsFloat(
      expected: number,
      found: number,
      msg?: string,
    ): void;
    static assertNotEqualsFloat(
      expected: number,
      found: number,
      msg?: string,
    ): void;
    ...
    static assertArgumentsCount(
      args: any,
      minCount: number,
      maxCount: number,
      msg?: string,
    ): void;
    static assertEventFired(
      obj: qx.core.Object,
      event: string,
      invokeFunc: Function,
    ...
    static assertNotInArray(
      value: any,
      array: qx.data.Array,
      msg?: string,
    ): void;
    static assertArrayEquals(
      expected: qx.data.Array,
      found: qx.data.Array,
      msg?: string,
    ): void;
...
declare module qx.core {
  class Property {
    ...
    static executeOptimizedGetter(
      instance: qx.core.Object,
      clazz: qx.Class,
      name: string,
      variant: string,
    ): any;
    static executeOptimizedSetter(
      instance: qx.core.Object,
      clazz: qx.Class,
      name: string,
      variant: string,
...
declare module qx.util {
  class DeferredCallManager
    extends qx.core.Object
    implements qx.core.IDisposable
  {
    dispose(): void;
...
declare module qx.util {
  class Serializer {
    static toUriParameter(
      object: qx.core.Object,
      qxSerializer?: Function,
      dateFormat?: qx.util.format.DateFormat,
    ): string;
    static toNativeObject(
      object: qx.core.Object,
      qxSerializer?: Function,
      dateFormat?: qx.util.format.DateFormat,
    ): null | qx.data.Array | string | {};
    static toJson(
      object: qx.core.Object,
      qxSerializer?: Function,
      dateFormat?: qx.util.format.DateFormat,
...
declare module qx.util {
  class DisposeUtil {
    ...
    protected static _collectContainerChildren(
      container:
        | qx.ui.container.Composite
        | qx.ui.container.Scroll
        | qx.ui.container.SlideBar
...
declare module qx.util.format {
  class NumberFormat
    extends qx.core.Object
    implements qx.util.format.IFormat, qx.core.IDisposable
  {
...
declare module qx.util.placement {
  class AbstractAxis {
    ...
    protected static _moveToEdgeAndAlign(
      size: number,
      target: IMap,
      offsets: IMap,
      position: string,
    ): number;
    protected static _isInRange(
      start: number,
      size: number,
      areaSize: number,
    ): boolean;
...
declare module qx.module.util {
  class String {
    ...
    static firstLow: any;
    static startsWith(
      fullstr: qx.module.util.String,
      substr: qx.module.util.String,
    ): boolean;
    static endsWith(
      fullstr: qx.module.util.String,
      substr: qx.module.util.String,
...
declare module qx.module {
  class Placement {
    ...
    protected static _computePlacement(
      axes: IMap,
      size: IMap,
      area: IMap,
      target: IMap,
...
declare module qx.module {
  class Traversing {
    ...
    static equalNodes(
      node1: string | HTMLElement | HTMLElement | any,
      node2: string | HTMLElement | HTMLElement | any,
    ): boolean;
...
declare module qx.module {
  class Event {
    ...
    static $registerEventNormalization(
      types: string[],
      normalizer: Function,
    ): void;
    static $unregisterEventNormalization(
      types: string[],
      normalizer: Function,
    ): void;
    static $getEventNormalizationRegistry(): IMap;
    static $registerEventHook(
      types: string[],
      registerHook: Function,
      unregisterHook?: Function,
    ): void;
    static $unregisterEventHook(
      types: string[],
      registerHook: Function,
      unregisterHook?: Function,
    ): void;
    ...
    onMatchTarget(
      eventType: string,
      target: string | HTMLElement | HTMLElement | any,
      callback: Function,
      context?: {},
    ): any;
    offMatchTarget(
...
declare module qx.module.dev {
  class FakeServer {
    ...
    static respondWith(
      method: string,
      urlRegExp: RegExp,
      response: Function | qx.data.Array | string,
    ): void;
...
declare module qx.io.transport {
  class Xhr
    extends qx.io.transport.AbstractTransport
    implements qx.io.transport.ITransport
  {
...
declare module qx.io.transport {
  class AbstractClient extends qx.core.Object {
    static registerTransport(
      uriRegExp: RegExp,
      transportClass: qx.io.transport.ITransport,
    ): void;
...
declare module qx.io.jsonrpc {
  class Client extends qx.io.transport.AbstractClient {
    constructor(
      transportOrUri?: qx.io.transport.ITransport | string,
      methodPrefix?: string,
      parser?: qx.io.jsonrpc.protocol.Parser,
    );
    ...
    handleMessage(
      message: qx.io.jsonrpc.protocol.Message | qx.io.jsonrpc.protocol.Batch,
    ): void;
...
declare module qx.io.graphql {
  class Client extends qx.io.transport.AbstractClient {
    ...
    protected _handleErrors(
      response: qx.io.graphql.protocol.Response,
...
declare module qx.io.request {
  class AbstractRequest extends qx.core.Object implements qx.core.IDisposable {
    ...
    protected _serializeData(
      data: string | IMap | qx.core.Object,
    ): string | null;
    getUrl(): string;
    ...
    setAuthentication(
      value: qx.io.request.authentication.IAuthentication,
    ): void;
...
declare module qx.io.request.authentication {
  class Bearer
    extends qx.core.Object
    implements qx.io.request.authentication.IAuthentication
  {
    getAuthHeaders(): IMap[];
...
declare module qx.io.part {
  class Part {
    ...
    protected _appendPartListener(
      callback: Function,
      self?: {},
      part?: qx.io.part.Part | qx.io.part.ClosurePart,
    ): void;
...
declare module qx.io.rest {
  class Resource extends qx.core.Object implements qx.core.IDisposable {
    ...
    protected _tailorResource(
      resource: qx.bom.rest.Resource,
...
declare module qx.lang {
  class Array {
    ...
    static replace(
      dest: qx.data.Array | qx.data.Array,
      src: qx.data.Array | qx.data.Array,
    ): qx.lang.Array;
    static toNativeArray(
      src: qx.data.Array | qx.data.Array,
      param1: any,
    ): qx.lang.Array;
    static toDataArray(
...
declare module qx.lang.normalize {
  class Array {
    ...
    static filter(
      callback: qx.lang.normalize.Function,
      obj?: {},
    ...
    static includes(
      searchElement: any,
      fromIndex: qx.lang.normalize.Number,
    ): boolean;
  }
}
declare module qx.lang.normalize {
...
declare module qx.lang.normalize {
  class String {
    ...
    static startsWith(
      searchString: qx.lang.normalize.String,
      position?: number,
    ): boolean;
    static endsWith(
      searchString: qx.lang.normalize.String,
...
declare module qx.lang.normalize {
  class Object {
    ...
    static is(
      x: qx.lang.normalize.Object,
      y: qx.lang.normalize.Object,
    ): boolean;
    static assign(
      target: qx.lang.normalize.Object,
      sources: qx.lang.normalize.Object,
    ): qx.lang.normalize.Object;
  }
}
declare module qx.lang {
...
declare module qx.dom {
  class Hierarchy {
    ...
    static isDescendantOf(
      element: qx.dom.Element,
      ancestor: qx.dom.Element,
    ): boolean;
    static getCommonParent(
      element1: qx.dom.Element,
      element2: qx.dom.Element,
    ): qx.dom.Element;
    ...
    protected static _recursivelyCollect(
      element: qx.dom.Element,
      property: string,
    ): qx.data.Array;
...
declare module qx.log {
  class Logger {
    ...
    static deprecatedEventWarning(
      clazz: qx.Class,
      event: string,
      msg?: string,
    ): void;
    static deprecatedMixinWarning(clazz: qx.Class, msg?: string): void;
    static deprecatedConstantWarning(
      clazz: qx.Class,
      constant: string,
      msg: string,
    ): void;
    static deprecateMethodOverriding(
      object: qx.core.Object,
      baseclass: qx.Class,
      methodName: string,
      msg?: string,
...
declare module qx.data {
  class SingleValueBinding {
    static bind(
      sourceObject: qx.core.Object,
      sourcePropertyChain: string,
      targetObject: qx.core.Object,
      targetPropertyChain: string,
      options?: IMap,
    ): any;
    static updateTarget(
      sourceObject: qx.core.Object,
    ...
    static removeRelatedBindings(
      object: qx.core.Object,
      relatedObject: qx.core.Object,
    ): void;
...
declare module qx.data.controller.website {
  class List extends qx.core.Object {
    constructor(
      model?: qx.data.IListData | qx.data.Array,
      target?: HTMLElement,
      templateId?: string,
    );
    protected _applyModel(): void;
...
declare module qx.data.controller {
  class MSelection {
    ...
    protected _applySelection(
      value: qx.data.Array,
      old: qx.data.Array | null,
    ): void;
    protected _changeTargetSelection(): void;
    protected _addChangeTargetListener(
      value: qx.ui.core.Widget | null,
      old: qx.ui.core.Widget | null,
    ): void;
    protected _updateSelection(): void;
...
declare module qx.data.controller {
  class Object extends qx.core.Object {
    ...
    protected _applyModel(
      value: qx.core.Object | null,
      old: qx.core.Object | null,
    ): void;
    addTarget(
      targetObject: qx.core.Object,
      targetProperty: string,
...
declare module qx.data.controller {
  class List extends qx.core.Object implements qx.data.controller.ISelection {
    ...
    constructor(
      model?: qx.data.Array,
      target?: qx.ui.core.Widget,
      labelPath?: string,
    );
    update(): void;
    protected _applyDelegate(
      value: qx.core.Object | null,
      old: qx.core.Object | null,
    ): void;
    ...
    protected _onBindingSet(
      index: number,
      sourceObject: qx.core.Object,
      targetObject: qx.core.Object,
    ): void;
    protected _removeBindingsFrom(item: number): void;
    protected _setConfigureItem(
      value: qx.data.controller.Object,
      old: qx.data.controller.Object,
    ): void;
    protected _setBindItem(
      value: qx.data.controller.Object,
      old: qx.data.controller.Object,
    ): void;
    protected _setCreateItem(
      value: qx.data.controller.Object,
      old: qx.data.controller.Object,
    ): void;
...
declare module qx.data.controller {
  class Form extends qx.core.Object implements qx.core.IDisposable {
    dispose(): void;
    constructor(
      model?: qx.core.Object | null,
      target?: qx.ui.form.Form | null,
      selfUpdate?: boolean,
    );
    addBindingOptions(
      name: string,
...
declare module qx.data.controller {
  class Tree extends qx.core.Object implements qx.data.controller.ISelection {
    ...
    protected _applyLabelOptions(value: IMap | null, old: IMap | null): void;
    protected _applyTarget(
      value: qx.ui.tree.Tree | null,
      old: qx.ui.tree.Tree | null,
    ): void;
    protected _applyModel(
      value: qx.core.Object | null,
      old: qx.core.Object | null,
    ...
    bindProperty(
      ...
      targetPath: string,
      options: IMap | null,
      targetWidget: qx.ui.tree.core.AbstractTreeItem,
      modelNode: any,
    ): void;
    bindPropertyReverse(
      targetPath: string | null,
      sourcePath: string,
      options: IMap | null,
      sourceWidget: qx.ui.tree.core.AbstractTreeItem,
      modelNode: any,
    ): void;
    bindDefaultProperties(
      treeNode: qx.ui.tree.core.AbstractTreeItem,
      modelNode: qx.core.Object,
    ): void;
    protected _setConfigureItem(
      value: qx.data.controller.Object,
      old: qx.data.controller.Object,
...
declare module qx.event.handler {
  class Touch
    ...
    implements qx.event.IEventHandler, qx.core.IDisposable
  {
    canHandleEvent(target: any, type: string): boolean;
    registerEvent(target: any, type: string, capture: boolean): void;
    unregisterEvent(target: any, type: string, capture: boolean): void;
...
declare module qx.event.handler {
    ...
    implements qx.event.IEventHandler, qx.core.IDisposable
  {
    ...
    static TARGET_CHECK: any;
    static IGNORE_CAN_HANDLE: any;
    protected _fireInputEvent(
      domEvent: qx.event.type.Event,
      charCode: number,
    ): qx.Promise | null;
    protected _fireSequenceEvent(
      domEvent: qx.event.type.Event,
      type: string,
      keyIdentifier: string,
    ): qx.Promise | null;
    ...
    protected _idealKeyHandler(
      keyCode: string,
      charCode: string,
      eventType: string,
      domEvent: qx.event.handler.Element,
    ): qx.Promise | null;
...
declare module qx.event.handler {
  class GestureCore implements qx.core.IDisposable {
    ...
    protected _stopObserver(): void;
    checkAndFireGesture(
      domEvent: qx.event.type.Pointer,
      type?: string,
      target?: HTMLElement,
    ): void;
    ...
    protected _isBelowTapMaxDistance(
      domEvent: qx.event.type.Event,
    ): boolean | null;
...
declare module qx.event.handler {
  class TouchCore implements qx.core.IDisposable {
    ...
    protected _onTouchEvent(domEvent: qx.event.type.Event): void;
    protected _getScalingDistance(
      touch0: qx.event.type.Event,
      touch1: qx.event.type.Event,
    ): number;
    protected _getRotationAngle(
      touch0: qx.event.type.Event,
      touch1: qx.event.type.Event,
    ): number;
    ...
    protected _commonTouchEventHandler(
      domEvent: qx.event.type.Event,
      type?: string,
    ): void;
    protected _detectTouchesByPointer(
      domEvent: qx.event.type.Event,
      type?: string,
    ): qx.data.Array;
...
declare module qx.event.dispatch {
  class Direct implements qx.event.IEventDispatcher {
    canDispatchEvent(
      target: HTMLElement | qx.event.type.Event,
      event: qx.event.type.Event,
      type: string,
    ): boolean;
    dispatchEvent(
...
declare module qx.event {
  class Registration {
    ...
    static fireEventAsync(
      target: {},
      type: string,
      clazz?: qx.Class,
      args?: qx.data.Array,
    ): qx.Promise;
    static fireNonBubblingEvent(
      target: {},
      type: string,
      clazz?: qx.Class,
      args?: qx.data.Array,
...
declare module qx.event.type {
  class Native extends qx.event.type.Event {
    protected _cloneNativeEvent(
      nativeEvent: qx.event.type.Event,
      clone: {},
    ): {};
